  ...
  >
    <defs>
      <radialGradient id="bronzeGradient" cx="50%" cy="50%" r="50%">
        ...
        {/* very light bronze center */}
        <stop offset="40%" stopColor="#dca87f" /> {/* mid bronze */}
        <stop offset="70%" stopColor="#b87333" /> {/* strong bronze */}
        <stop offset="100%" stopColor="#7c4a1e" /> {/* dark bronze edge */}
      </radialGradient>

      <linearGradient id="bronzeHighlight" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#fff" stopOpacity="0.5" />
        <stop offset="20%" stopColor="#fff" stopOpacity="0" />
        <stop offset="80%" stopColor="#b87333" stopOpacity="0" />
        <stop offset="100%" stopColor="#b87333" stopOpacity="0.5" />
      </linearGradient>

      <radialGradient id="bronzeShine" cx="70%" cy="30%" r="20%">
...
export { SvgComponent as BronzeMostKills };
