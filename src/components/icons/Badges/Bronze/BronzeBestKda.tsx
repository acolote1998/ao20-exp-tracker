...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor="#8C4A2F" /> {/* Dark Bronze */}
        <stop offset={1} stopColor="#CD7F32" /> {/* Classic Bronze */}
      </linearGradient>
    </defs>
    <g fillRule="evenodd">
      <path
...
export { SvgComponent as BronzeBestKda };
