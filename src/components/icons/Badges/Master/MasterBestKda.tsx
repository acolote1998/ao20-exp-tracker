...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor="#fa16d4" /> {/* Vibrant pink/fuchsia */}
        <stop offset={1} stopColor="#f9c6e7" /> {/* Light pastel pink */}
      </linearGradient>
    </defs>
    <g fillRule="evenodd">
      <path
...
export { SvgComponent as MasterBestKda };
