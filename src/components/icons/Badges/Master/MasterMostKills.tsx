  ...
  >
    <defs>
      <radialGradient id="masterGradient" cx="50%" cy="50%" r="50%">
        ...
        <stop offset="100%" stopColor="#7a0a62" /> {/* Dark magenta edge */}
      </radialGradient>

      <linearGradient id="metalHighlight" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#fff" stopOpacity="0.8" />
        <stop offset="20%" stopColor="#fff0f6" stopOpacity="0" />
        <stop offset="80%" stopColor="#f56fc7" stopOpacity="0" />
        <stop offset="100%" stopColor="#f56fc7" stopOpacity="0.6" />
      </linearGradient>
    ...
    <path
      ...
      style={{
        fill: "#b21092", // darker magenta contrast
        stroke: "#7a0a62",
        strokeWidth: 0.8,
      }}
    />
...
export { SvgComponent as MasterMostKills };
