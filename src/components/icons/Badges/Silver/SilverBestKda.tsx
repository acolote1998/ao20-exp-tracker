...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor="#A0A0A0" /> {/* Dark Silver */}
        <stop offset={1} stopColor="#E0E0E0" /> {/* Light Silver */}
      </linearGradient>
    </defs>
    <g fillRule="evenodd">
      <path
        ...
        style={{
          fill: "url(#silverGradientBestKda)",
        }}
      />
      <path
...
export { SvgComponent as SilverBestKda };
