  ...
  >
    <defs>
      <radialGradient id="goldGradient" cx="50%" cy="50%" r="50%">
        ...
        {/* Very light yellow center */}
        <stop offset="40%" stopColor="#ffd54f" /> {/* Bright gold mid */}
        <stop offset="70%" stopColor="#ffb300" /> {/* Strong gold */}
        <stop offset="100%" stopColor="#b8860b" /> {/* Dark amber edge */}
      </radialGradient>

      <linearGradient id="metalHighlight" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#fff" stopOpacity="0.8" />
        <stop offset="20%" stopColor="#fff" stopOpacity="0" />
        <stop offset="80%" stopColor="#f0c419" stopOpacity="0" />
        <stop offset="100%" stopColor="#f0c419" stopOpacity="0.6" />
      </linearGradient>

      <radialGradient id="shine" cx="70%" cy="30%" r="20%">
    ...
    <path
      ...
      style={{
        fill: "#f2b600", // brighter goldenrod
        stroke: "#7a5900",
        strokeWidth: 1,
      }}
    />
    ...
    <path
      ...
      style={{
        fill: "#cc9900", // deeper gold contrast
        stroke: "#7a5900",
        strokeWidth: 0.8,
      }}
    />
    ...
    <ellipse
      ...
      ry={10.671}
      style={{
        fill: "url(#shine)", // bright shine on ellipse
        stroke: "#b8860b",
        strokeWidth: 0.5,
      }}
    />
...
export { SvgComponent as GoldMostKills };
