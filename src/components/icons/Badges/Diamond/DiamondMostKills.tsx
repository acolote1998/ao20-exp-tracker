  ...
  >
    <defs>
      <radialGradient id="diamondGradient" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stopColor="#e6f7ff" /> {/* Very light blue center */}
        <stop offset="40%" stopColor="#88badd" /> {/* Gentle blue core */}
        <stop offset="70%" stopColor="#4b84a9" /> {/* Mid-tone blue */}
        <stop offset="100%" stopColor="#2b5e86" /> {/* Deep sapphire edge */}
      </radialGradient>

      <linearGradient id="diamondHighlight" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#ffffff" stopOpacity="0.7" />
        <stop offset="20%" stopColor="#ffffff" stopOpacity="0.2" />
        <stop offset="80%" stopColor="#2b5e86" stopOpacity="0" />
        <stop offset="100%" stopColor="#2b5e86" stopOpacity="0.4" />
      </linearGradient>

      <radialGradient id="diamondShine" cx="70%" cy="30%" r="20%">
...
export { SvgComponent as DiamondMostKills };
