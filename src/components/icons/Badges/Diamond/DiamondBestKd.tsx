...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      >
        <stop offset={0} stopColor="#2A4D69" /> {/* Deep cold blue */}
        <stop offset={1} stopColor="#A0D8EF" /> {/* Bright arctic shimmer */}
      </linearGradient>
    </defs>
    <g fillRule="evenodd">
      <path
...
export { SvgComponent as DiamondBestKda };
